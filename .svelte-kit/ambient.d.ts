...
declare module '$env/static/private' {
	...
	export const R2_LTSEC_ACCESS: string;
	export const SSH_AUTH_SOCK: string;
	export const FLYCTL_INSTALL: string;
	export const R2_LTSEC_SECRET: string;
	...
	export const LMOD_SHELL_PRGM: string;
	...
	export const LXD_SOCKET: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		R2_LTSEC_ACCESS: string;
		SSH_AUTH_SOCK: string;
		FLYCTL_INSTALL: string;
		R2_LTSEC_SECRET: string;
		COLOR: string;
